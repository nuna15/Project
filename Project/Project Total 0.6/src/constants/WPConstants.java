...
public class WPConstants {
	...
	public static final String PAGE_URL_EXIT = "exit.html";
	...
	public static final String LOG_CONCERT_REGISTER = "Concert Register";
	public static final String LOG_CONCERT_INSTANCE_REGISTER = "Concert Instance Register";
	...
	public static final int SEAT_ROW = 10;
	public static final int SEAT_COLUMN = 5;

	// Reservation Status

	public static final int RESERVATION_OK = 1;
	public static final int RESERVATION_CANCLE = 0;
