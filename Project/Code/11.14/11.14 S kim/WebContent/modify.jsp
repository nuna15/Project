	...
	<div id="content">
		...
		<div class="section_1" id="reserve_detail">
			...
			<div class="section_2" id="left">
				...
				<a href="modifyForm.jsp"><button
						onclick="location.href('mypage_modify.html')">수정하러가기</button></a><br />
			</div>
			...
			<div class="section_2" id="right">
				...
				<a href="mypage_orderlist.html"><button
						onclick="location.href('mypage_orderlist.html')">자세히보기</button></a><br />
