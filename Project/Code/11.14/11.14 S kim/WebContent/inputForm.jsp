...
<!--
	function checkIt() {//사용자가 입력폼에 입력한 상황을 체크
		...
		if (!userinput.id.value) {//아이디를 입력하지 않으면 수행
			alert("ID를 입력하세요");
		...
		if (userinput.passwd.value != userinput.passwd2.value) {//비밀번호와 재입력비밀번호가 같지않으면 수행
	...
	<div id="wrap">
		...
		<div id="content">
			...
			<div class="section_1" id="reserve_detail">
				<!--예매상세내역-->
				<div class="container">
					<form class="well" method="post" action="inputPro.jsp"
								...
								<table>
									<tr>
										...
										<td><input type="text" name="id" maxlength="10" /> <input
											type="button" name="IDcheck" value="중복확인"
									...
									<tr>
										<th>Password 확인</th>
										<td><input type="password" name="passwd2" maxlength="10" />
										</td>
									</tr>
									<tr>
										<th>성명(한글)</th>
									...
									<tr>
										<th>주민등록번호</th>
										<td><input type="text" name="jumin1" maxlength="6" /> -<input
											type="text" name="jumin2" maxlength="7" /></td>
									</tr>
									<tr>
										<th>facebook 아이디&nbsp;</th>
										<td><input type="text" name="facebook" maxlength="30" />
										</td>
									</tr>
								</table>
							</li>
...
본 약관은 2012년 4월 19일부터 시행합니다.
										...
										<input type="checkbox" class="check" name="apply" />약관에
										동의합니다.
									</div>
									<div class="rightside">
										<table>
...
- 소비자의 불만 또는 분쟁처리에 관한 기록 : 3년
							...
							<li>
								<div class="submit">
									<input type="submit" value="회원가입" name="confirm" /> <input
