			...
			<div class="section_1" id="reserve_detail">
				...
				<center>
					<form class="well" action="ReviewManageController" method="post"
						...
						<div class="report">
							<!--공연 선택 : <input type="text" name="concertName" class="title"></input><br /> -->
							공연 선택 : <select class="select" name="concertName">
								<c:forEach var="list" items="${concerts}">
									<option value="${list.concertName}">${list.concertName}</option>
								</c:forEach>
							</select> <br /> 리뷰 제목 : <input type="text" name="reviewName"
								class="title"></input><br /> 리뷰 내용 :
