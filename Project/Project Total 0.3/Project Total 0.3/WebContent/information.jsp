...
<link href="stylesheets/concert/information.css" rel="stylesheet" type="text/css">
		...
		<div id="content">
			...
			<div class="section_1">
				...
				<div class="section_1_right" id="story">
					...
					<p class="1" style="display: none">아내를 친정에 보내고 모델 애인과 기막힌 파티를
						준비하는 양평펜션의 주인 우진. 오.마.이.갓! 그러나 아내는 친정 나들이를 취소한다!! 아내 몰래 바람피우는 남편,
						남편의 친구와 사랑에 빠진 아내, 죽마고우의 부인과 사랑에 빠진 친구, 명품과 사랑에 빠진 남편의 애인, 그리고
						돈이라면 무엇이든 다 하는 요리사까지..!! 잠시도 눈을 뗼 수 없는 다섯 남녀의 기막힌 스캔들 현장. 스캔들을
						훔쳐보는 재미 아시죠? 이제 대놓고 훔쳐보세요!</p>
				</div>
			</div>
			<div class="section_1">
				<!-- 공연사진,평점,리뷰 바로가기, 줄거리-->
				...
				<div class="section_1_right" id="story">
					...
					<p class='2' style="display: none">100일 커플, 이제 사랑을 막 시작한 풋풋함이
						느껴지는 커플. 아직은 함께한 시간이 많지는 않지만, 철민은 다슬에게 변치 않는 마음과 영원한 사랑을 약속한다. 다슬도
						그런 철민이 너무 좋고, 마냥 설렌다. 다슬은 100일을 맞아 부모님께 사랑하는 남자친구를 소개 시켜주려고 하는데...
						사랑을 하면서 가장 설레고, 두근거리는 시기인 100일. 그들이 말하는 ‘사랑’의 무게는 어떨까? 1000일 커플,
						연애 3년 차인 이 커플은 슬슬 권태기에 접어든다. 미진은 사소한 것에서 꼬투리를 잡으며, 이 모든 것은 영민이
						자신에게 마음이 멀어졌기 때문이라 생각해서 온갖 짜증을 부린다. 영민은 이런 미진이 이해가 가지 않는다. 권태기인
						커플의 반복되는 싸움과 화해. 이 속에서 그들은 진짜 사랑을 찾을 수 있을까? 10년 커플, 다른 사람들은 이 커플을
						보고 연인이기 보다는 부부 혹은 친구라 부른다. 그대들의 사랑은 사랑이 아닌 우정이라고. 용석의 기타 치는 모습을 보고
						반한 은진. 그러나 10년 째, 기타만 치고 있는 용석. 이런 용석이 답답한 은진은 용석에게 결혼을 재촉한다. 그러나
						용석은 사람 좋은 웃음으로 그 상황만을 모면하려고 하는데... 사랑 혹은 우정. 그리고 이상과 현실 사이에 서 있는
						이들의 이야기. 10년 동안 지켜 온 그들의 사랑을 끝까지 지켜 낼 수 있을까?</p>
				</div>
			</div>
			...
			<div class="section_1">
				...
				<div class="section_1_right" id="story">
					...
					<p class="3" style="display: none">＂너무 불공평해. 태어날 때부터 인생의 반이
