	...
	<div id="wrap">
			...
			<div class="navbar-inner">
				<div class="container">
					<ul class="nav">
						...
						<li class="active"><a href="membership_bootstrap.html">멤버십</a></li>
					</ul>
				</div>
			</div>
		</div>
		...
		<div id="content"> <!-- 실직적으로 보여질 정보들-->
			<div id="top">
				...
				<ul>
					<li class='section'>
						<p align="center"><b> 멤버쉽 기본 혜택 </b></p>
						<ul>
					...
					<li class='section'>
						<p align="center"><b> 멤버쉽 가입 방법 </b></p>
							<ol>
								<li>홈페이지 회원 가입 / 카드발급신청<br/>
								(카드발급 신청 양식 작성)</li>
								<li>극장에서 멤버십 카드 수령<br/>
								(회원가입 및 카드번호 등록)</li>
							</ol>
					</li>
				</ul>
			...
			<div id="middle">
				<table border="1">
					...
					<tr>
						<td><img src="http://postfiles4.naver.net/20121101_243/exteria_1351705509889lbuBR_JPEG/vip.jpg?type=w3"></td>
						<td>
						<ol>
							<li>공연 예매시 20% 할인</li>
					...
					<tr>
						<td><img src="http://postfiles12.naver.net/20121101_283/exteria_1351705509781vBdGm_JPEG/platinum.jpg?type=w3"></td>
						<td>
						<ol>
							<li>공연 예매시 15% 할인</li>
					...
					<tr>
						<td><img src="http://postfiles14.naver.net/20121101_221/exteria_1351705509476d4AnB_JPEG/gold.jpg?type=w3"></td>
						<td>
						<ol>
							<li>공연 예매시 10% 할인</li>
							<li>공연 관람 금액 5% 적립</li>
