...
<body>
	...
	<div id="wrap">
		...
		<div class="navbar">
			<div class="navbar-inner">
				<div class="container">
					<ul class="nav">
						<li><a href>공연</a></li>
						<li class="active"><a href>예약 </a></li>
						<li><a href>리뷰</a></li>
						<li><a href>멤버십</a></li>
					</ul>
				</div>
		...
		<div id="content"><!-- 실직적으로 보여질 정보들-->
			...
			<div class="section_1" id="reserve_note"><!--예매상세내역-->
				<ul>
					<hr/>
					<li>예매내용, 결제 변경안내</li>
					동일 상품에 대해서 날짜, 시간, 좌석, 가격등급, 결제 등의 일부 변경을 원하시는 경우
					기존예매건을 취소하시고 재예매하셔야 합니다. 단, 할인은 재예매 시점을 기준으로 적용됩니다.<br/>
					
					<li>환불 안내</li>
						예매 취소시에 환불 계좌번호를 남기고, 그 계좌를 통해 취소수수료 및 이체수수료를 제외한 금액을 환불받습니다.
						취소 후 고객님의 계좌로 입금까지 약 5-7일 정도가 소요됩니다. (주말 제외)
						환불은 반드시 예매자 본인 명의의 계좌로만 받으실 수 있습니다. 단, 예매자 본인 명의의 계좌가 없을 경우에는 직계 가족 명의의 계좌에 한하여 가능하며, 이 경우 관계를 증명할 수 있는 증빙서류를 팩스나 우편 등으로 코코엔터테인먼트 공연기획본부로 보내주셔야 합니다.
				</ul>
			</div>
        </div>
